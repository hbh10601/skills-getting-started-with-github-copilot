...
activities = {
    ...
    "Basketball Club": {
        "description": "Drills, scrimmages, and game strategy for all skill levels",
    ...
    "Art Studio": {
        ...
        "max_participants": 15,
        "participants": ["ava@mergington.edu", "lucy@mergington.edu"]
    },
    "Drama Workshop": {
    ...
    "Science Olympiad": {
        "description": "Competitive science challenges and hands-on experiments",
        "schedule": "Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 14,
        "participants": ["noah@mergington.edu", "emma@mergington.edu"]
    },
    "Debate Team": {
        "description": "Research, public speaking, and persuasive argument coaching",
